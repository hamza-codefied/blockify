...
export const PERMISSIONS = {
  ...
  // Allowed Apps
  ALLOWED_APPS_READ: formatPermission(RESOURCES.ALLOWED_APPS, ACTIONS.READ),
  ALLOWED_APPS_CREATE: formatPermission(RESOURCES.ALLOWED_APPS, ACTIONS.CREATE),
  ALLOWED_APPS_UPDATE: formatPermission(RESOURCES.ALLOWED_APPS, ACTIONS.UPDATE),
  ALLOWED_APPS_DELETE: formatPermission(RESOURCES.ALLOWED_APPS, ACTIONS.DELETE),
};
